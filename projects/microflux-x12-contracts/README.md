...
By default the template creates a single `HelloWorld` contract under workflow_executor folder in the `smart_contracts` directory. To add a new contract:
